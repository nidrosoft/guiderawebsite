...
import icon_2 from "@/assets/images/icon/icon_02.svg"
import icon_3 from "@/assets/images/icon/icon_03.svg"
         ...
         <div className="row gx-xl-4">
            {feature_data.map((item) => (
               <div key={item.id} className="col-lg-4 d-flex mt-30 lg-mt-20">
                  <div className="card-style-one text-center border-30 bg-white w-100">
